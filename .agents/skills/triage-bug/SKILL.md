---
name: triage-bug
description: Use this skill to triage a bug report against the source: reproduction, root cause, severity, blast radius, and a proposed regression test. Use when given a bug report, defect, or customer complaint to investigate.
---
