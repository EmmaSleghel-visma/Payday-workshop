...
description: Use this skill to generate an edge-case data set for an input or calculation, then prioritise it against the real source. Use when asked for test data, boundary values, edge cases, or negative test inputs.
---
