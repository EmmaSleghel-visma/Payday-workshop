...
description: Use this skill to compare what the app actually does against what the test suite verifies, and rank the gaps by risk. Use when asked about test coverage, coverage gaps, or what to test next.
---
