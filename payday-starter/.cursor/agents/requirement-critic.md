...
readonly: true
---
<!-- GENERATED from agents/requirement-critic.md by agents/_generate.py — do not edit directly. -->
...
- **`test-planner`** — Plan the tests. Ask it: *A human has approved the acceptance criteria above. Plan the test coverage for them, including the open questions I raised as explicit risks.*
